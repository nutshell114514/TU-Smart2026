...
# Camera / Model Setup
# =========================
# Best training pipeline so far:
# 1. Full QQVGA frame (160x120)
# 2. Crop ROI=(32, 16, 96, 96)
# 3. Train a 2-class FOMO model (background + objects)
#
# To reduce train/deploy mismatch, keep deployment exactly aligned to that ROI.

MODEL_PATH = "/sd/trained.tflite"
LABEL_PATH = "/sd/labels.txt"

FRAME_SIZE = sensor.QQVGA  # 160x120
ROI = (32, 16, 96, 96)     # must match the training crop

# =========================
# Detection Profiles
# =========================
# Switch PROFILE_NAME to quickly test different post-processing strengths.
# - fast: more sensitive, more detections, more jitter
# - balanced: good default
# - stable: stronger anti-jitter, best for live demo
...
# On-device camera auto settings are often needed to reach a sane exposure.
# Locking them too early can leave the whole preview washed out.
...
# Let the camera settle first. Only lock settings if we explicitly opt in.
