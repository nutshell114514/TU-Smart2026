...
_PUSH_SPEED_FOLLOWER = const(150)
...
_RECOVER_TRANSLATE_SPEED = const(130)
...
_RECOVER_DIAG_ORBIT_SPEED = const(150)
...
def _reset_search():
    ...
    # 与主车使用相同的 SEARCH 航向来源：首次使用配置模式选择 90/0 度；
